const sections = [
  {
    ...
    body: [
      ...
      "Esta política se aplica a la web bancaria, APIs internas, documentos generados, módulo de nóminas, soporte, pagos ficticios y Programa BETA Android."
    ]
  },
  {
    ...
    body: [
      ...
      "Datos del Programa BETA Android: nombre opcional, correo electrónico o número de WhatsApp, canal elegido, fecha de inscripción y estado de invitación."
    ]
  },
  {
    ...
    body: [
      ...
      "En el Programa BETA Android, la base jurídica principal es el consentimiento prestado al solicitar la inscripción y aceptar recibir comunicaciones por el canal elegido."
    ]
  },
  {
    ...
    body: [
      ...
      "Las inscripciones beta se conservarán mientras dure el programa de pruebas o hasta que el interesado solicite la baja o supresión del dato de contacto."
    ]
  },
  {
    ...
    body: [
      ...
      "Retirada del consentimiento: cancelar comunicaciones beta o cualquier tratamiento basado únicamente en consentimiento sin afectar a la licitud del tratamiento previo."
    ]
  },
  {
    ...
    body: [
      ...
      "Los mensajes por WhatsApp o correo electrónico pueden implicar proveedores externos del canal elegido. La Asociación limitará el contenido al mínimo necesario para gestionar la invitación."
    ]
  },
  {
    title: "7. Información por capas y comunicaciones",
    body: [
      "En los formularios se muestra una primera capa informativa con finalidad, canal y enlaces a esta política. Esta página desarrolla la información completa.",
      "No se enviarán comunicaciones comerciales ajenas al Banco de La Placeta ni al Programa BETA Android sin consentimiento específico adicional.",
      "El interesado puede solicitar información, baja o revisión del tratamiento a través de los canales oficiales de la Asociación."
    ]
  }
];
