import { GdlpSharedNewsItem } from "./bank";

export const periodicoNews: GdlpSharedNewsItem[] = [
  {
    slug: "edicion-cero-periodico-placeta",
    title: "Nace El Periodico de La Placeta con redaccion propia",
    tag: "Portada",
    ...
    body: [
      ...
      "La redaccion usara la API del ecosistema para guardar sus publicaciones, pero mantendra una coleccion independiente para no mezclar portada periodistica con anuncios de servicio."
    ],
    source: "periodico-gdlp",
    updatedAt: "2026-05-17T00:00:00.000Z"
  },
  {
    slug: "cronica-mercado-domingo",
    title: "Domingo de mercado: puestos llenos y nuevas historias en la plaza",
    tag: "Cronica",
    ...
    body: [
      ...
      "La redaccion recogera estas cronicas para que el pulso del barrio no quede perdido entre balances, formularios y pantallas de gestion."
    ],
    source: "periodico-gdlp",
    updatedAt: "2026-05-17T00:00:00.000Z"
  },
  {
    slug: "entrevista-taller-jovenes",
    title: "El taller joven prepara una seccion fija para contar proyectos nuevos",
    tag: "Entrevista",
    ...
    body: [
      ...
      "Las primeras entregas mezclaran entrevistas breves, fotos de avance y notas de campo escritas por los propios participantes."
    ],
    source: "periodico-gdlp",
    updatedAt: "2026-05-17T00:00:00.000Z"
  }
